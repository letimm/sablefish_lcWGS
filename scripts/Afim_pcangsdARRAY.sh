...
#SBATCH --job-name=pca_Afim
#SBATCH --output=/home/ltimm/Anoplopoma_fimbria/job_outfiles/Afim_pcangsd_%A-%a.out
...
JOBS_FILE=/home/ltimm/Anoplopoma_fimbria/scripts/Afim_pcangsdARRAY_input.txt
IDS=$(cat ${JOBS_FILE})
