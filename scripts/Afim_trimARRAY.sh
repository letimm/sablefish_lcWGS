...
#SBATCH --output=/home/ltimm/Anoplopoma_fimbria/job_outfiles/Afim_trimming_%A-%a.out
...
JOBS_FILE=/home/ltimm/Anoplopoma_fimbria/scripts/Afim_trimARRAY_input.txt
IDS=$(cat ${JOBS_FILE})
