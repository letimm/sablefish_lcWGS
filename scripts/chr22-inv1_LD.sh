...
#SBATCH --output=/home/ltimm/Anoplopoma_fimbria/job_outfiles/chr22-inv1_LD.out
...
BEAGLEIN=/home/ltimm/Anoplopoma_fimbria/chr22_inversions/chr22-inv1_4.13-8.19_0.3fst
BEAGLEOUT=chr22-inv1_ld
#INVNAME=chr22-inv1
CHROM=NC_072470.1
...
zcat $CHROMBEAGLE | grep -i -B 500 "NC_072470.1_4129968	" > $BASEDIR/$BEAGLEOUT.beagle

#get the interesting bit
#./${BEAGLEIN}.sh

#and subsample
#awk 'NR % 200 == 0' ${BEAGLEIN}.beagle >> $BASEDIR/$BEAGLEOUT.beagle

#OR don't
tail -n +2 ${BEAGLEIN}.beagle >> $BASEDIR/$BEAGLEOUT.beagle

#get 500 sites of the boring bit after the inversion
zcat $CHROMBEAGLE | grep -i -A 500 "NC_072470.1_8190205	" >> $BASEDIR/$BEAGLEOUT.beagle
